...
{
    public sealed class TwilioChannelVerificationProviderClient(TwilioClientOptions _twilioClientOptions) : BaseChannelVerificationChannelProviderRestClient(null)
    {
        ...
        private static string ToTwilioChannel(string? channel)
        {
            ...
            if (channel.Equals(Id.Channel.Voice(), StringComparison.OrdinalIgnoreCase))
                ...
                throw new TwilioClientException("Unexpected Transmitly channel.");
        }
